...
export default function Home({ data }: Readonly<{ data: any }>) {
  ...
  return (
    <motion.div {...pageFade} className="w-full bg-[#0a0a0a] overflow-hidden">
      {/* ================= HERO ================= */}
        ...
        <div className="absolute inset-0 flex justify-end items-end max-sm:justify-center">
          <AnimatedSection className="mr-20 mb-36 max-sm:mr-0 text-white max-sm:text-center max-w-xl">
            ...
            <h1 className="text-[46pt] max-sm:text-[30pt] font-light leading-tight mt-4">
              Curated Luxury <br /> Fragrance Collection
            </h1>
            ...
            <Link
              href="/shop"
              className="relative inline-flex mt-8 px-10 py-4 
            ...
            {data.map(
              (product: {
                ...
                >
                  ...
                  hover:border-[#BD955E]
                  hover:shadow-[0_20px_50px_rgba(189,149,94,0.15)]
                  ...
                  >
                    ...
                    <div className="px-6 py-5 text-center">
                      ...
                      <p className="text-[#BD955E] text-lg mt-3 font-bold">
                        {"$" + product.price + ".00"}{" "}
      ...
      <AnimatedSection className="py-24 border-b border-[#141414]">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10 text-center">
          <div>
            <p className="text-[#BD955E] text-sm tracking-widest uppercase">
              Authenticity
            </p>
            <h4 className="text-white mt-2 text-lg font-medium">
          ...
          <div className="flex justify-center gap-12 mt-16 flex-wrap">
            {[
              ...
              <Link
                ...
                border border-[#BD955E]/30 hover:border-[#BD955E] 
                transition duration-300"
              >
                <Image
